var translations = {
    ...
    "de": {
        ...
        "desc3": "Die POS-Schwierigkeit, Ergebnisse zu erzielen. Beim Start des Tools wird der letzte Wert für die POS-Schwierigkeit direkt aus der Stronghands-Blockchain abgerufen.",
        ...
        "footer_peercointalk": "Spenden für Stronghands Projekte",
        "footer_github": "Zu diesem Projekt auf GitHub beitragen",
        "noscript-text": "Der Stronghands-POS-Rechner braucht JavaScript, um zu funktionieren. Bitte aktivieren Sie JavaScript (<a href='https://www.enable-javascript.com/de/'>Wie JavaScript aktivieren</a>) und dann aktualisieren Sie."
    },
    "es": {
        ...
        "footer_peercointalk": "Donar a proyectos Stronghands",
    ...
    "fr": {
        ...
        "desc3": "La difficulté POS pour avoir un résultat. Au lancement de l'outil, la dernière valeur pour la difficulté POS est récupérée directement depuis la blockchain Stronghands.",
        ...
        "footer_peercointalk": "Faire un don aux projets Stronghands",
    ...
    "nl": {
        ...
        "desc3": "The POS difficulty value can be obtained from the console window of shnd-qt, you can get it with the command: getdifficulty. Or, if you have shndcoind running, in a command prompt: shndcoind getdifficulty.",
        ...
        "footer_peercointalk": "Doneer aan Stronghands projecten",
        "footer_github": "Draag bij aan dit project op GitHub"
    },
    "ru": {
        "title": "Stronghands POS Калькулятор",
        "header_prefix": "Языки: ",
        "header_title": "Stronghands доказательство Кола (POS) Калькулятор v0.0.1",
    ...
    "zh-cn": {
        ...
        "footer_peercointalk": "捐赠Stronghands的项目",
	...
	"no": {
        ...
        "desc5": "POS vanskelighetsgraden kan finnes gjennom konsollen til shnd-qt, ved å skrive kommandoen: shnd-qt. Hvis du har shndcoind i bakgrunnen kan du finne vanskelighetsgraden med: shndcoind getdifficulty",
        ...
        "footer_peercointalk": "Doner til Stronghands prosjekter",
